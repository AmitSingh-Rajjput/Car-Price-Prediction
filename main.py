...
app = Flask(__name__)                           #Initialize the app route
model = pickle.load(open('model.pkl', 'rb'))    #Load the save  model
...
def predict():
    ...
    if request.method == 'POST':
        Year = int(request.form['Year'])                        # Take data from form by users.
        ...
        Year=2021-Year                                  # For calculating total no of years
